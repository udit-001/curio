...
# Explorer and antivirus heuristics see legitimate PE metadata. Without this,
# Go binaries on Windows look "raw" to SmartScreen and AV heuristics.
#
# Usage:
#   ./scripts/gen-winres.sh                 # use winres/winres.json as-is
#   ./scripts/gen-winres.sh 0.1.0           # patch version into winres.json first
#
# The .syso files are written to cmd/curio/ and auto-linked by the Go toolchain
# for windows/* targets. Non-Windows builds ignore them.
set -euo pipefail

ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
WINRES_JSON="$ROOT/winres/winres.json"
OUT_DIR="$ROOT/cmd/curio"
      ...
      "0000": {
        ...
        "info": {
          "0409": {
            ...
            "FileDescription": "Curio",
            "FileVersion": "$VERSION",
            "InternalName": "curio",
            "LegalCopyright": "MIT License",
            "OriginalFilename": "curio.exe",
            "ProductName": "Curio",
  ...
  "RT_MANIFEST": {
    "#1": {
      "0409": {
        ...
        "description": "Search free-licensed image sources from the command line",
